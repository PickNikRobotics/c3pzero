...
TEST(RobotTask, load_behavior_plugins)
{
  ...
  {
    auto plugin_instance = class_loader.createUniqueInstance("c3pzero_behaviors::C3PzeroBehaviorsBehaviorsLoader");
  ...
  factory.instantiateTreeNode("test_behavior_name", "NavToGoalPose",
